if (!String.prototype.CortarTextoConPuntos) {
    Object.defineProperty(String.prototype, 'CortarTextoConPuntos',
        {
            value: function (limite) {
                if(!this) return "";
                if (this.length <= limite) return this;
                var puntosSuspensivos = "...";
                return this.substring(0, limite) + puntosSuspensivos;
            },
            enumerable: false
        });
}
function Formater() {
    ...
    this.formatDecimalString = function (text) {
        ...
        var textDecimal = "";
        if (indexDecimal > -1) {
            textDecimal = $params.uiDecimalSeparator + text.substring(indexDecimal).replace($params.uiDecimalSeparator, "");
